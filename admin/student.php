...
<div class="container" style="margin-top:30px">
  <div class="card">
    <div class="card-header">
      <div class="row">
        <div class="col-md-9">Danh sách sinh viên</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Tên sinh viên <span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Mã sinh viên <span class="text-danger">*</span></label>
              <div class="col-md-8">
...
<div class="modal" id="deleteModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <h3 align="center">Bạn chắc muốn xoá sinh viên này?</h3>
      </div>
...
<script>
  $(document).ready(function() {
    ...
    $('#add_button').click(function() {
      $('#modal_title').text('Thêm sinh viên');
